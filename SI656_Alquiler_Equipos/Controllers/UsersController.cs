...
namespace SI656_Alquiler_Equipos.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        {
            var user = db.User.Include(u => u.Rol);
        ...
        public ActionResult Edit([Bind(Include = "Id,Name,MotherLastName,FatherLastName,NameUser,Password,RolId,Email,MobileNumber")] User user)
        {
